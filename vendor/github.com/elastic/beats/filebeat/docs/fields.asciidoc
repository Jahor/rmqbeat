...
Contains fields for the RabbitMQ logs.
...
*`tomcat.access.geoip.continent_name`*::
+
--
type: keyword
...
*`tomcat.access.geoip.country_iso_code`*::
+
--
type: keyword
...
*`tomcat.access.geoip.region_name`*::
+
--
type: keyword
...
Logger that produced the message
...
Mapping name of a request


--

*`tomcat.log.request_id`*::
+
--
type: keyword
...
*`tomcat.log.geoip.continent_name`*::
+
--
type: keyword
...
*`tomcat.log.geoip.country_iso_code`*::
+
--
type: keyword
